...
- Developer onboarding: [`docs/technical/dev-setup.md`](../docs/technical/dev-setup.md)
- Product requirements: [`docs/product/PRD.md`](../docs/product/PRD.md)
- Domain glossary: [`docs/product/domain-glossary.md`](../docs/product/domain-glossary.md)
