...
### UB-13: App Initialization Boolean Flag (Implicit State Machine)
...
### UB-14: 10+ Глобальних Gesture State Флагів (Implicit State Machine)
...
### UB-15: Cursor Module-Level Cache (Implicit State)
...
### UB-20: window.h Debug Object (Side Effect)
...
### UB-21: window.collab у Prod (Side Effect)
...
### UB-22: overscrollBehaviorX Глобальна Мутація (Side Effect)
...
### UB-25: Library Save Hash — Конфлікт При Кількох Інстансах (Side Effect)
...
### UB-26: Scene.getScene() Singleton — Init Order Dependency
...
### UB-27: App Component Lifecycle Implicit Chain (Init Order)
...
### UB-28: Jotai Store vs Component Render Race (Init Order)
...
### UB-29: LocalData Static Debounce — Init Order
...
### UB-31: Magic Frame — Відсутній Cancellation (Async Race)
...
### UB-32: Concurrent Image Uploads — Race Condition (Async Race)
...
### UB-33: Socket Init Timer Leak (Async Race)
...
|----|-----------|------|-------|-------------|
| UB-01 | HACK | App.tsx | 689 | Середня |
| UB-02 | HACK (обірваний) | App.tsx | 7126 | Низька |
| UB-03 | TODO (perf) | frame.ts | 752 | Висока |
| UB-04 | TODO (perf) | snapping.ts | 44 | Середня |
| UB-05 | TODO (bug) | delta.ts | 726 | Висока |
| UB-06 | TODO (bug) | delta.ts | 1738 | Середня |
| UB-07 | TODO (arch) | restore.ts | 408 | Висока |
| UB-08 | TODO (dead code) | App.tsx | 417 | Низька |
| UB-09 | TODO (type abuse) | Collab.tsx | 499 | Середня |
| UB-10 | FIXME (stateful) | selection.ts | 138 | Середня |
| UB-11 | FIXME (unknown) | App.tsx | 8758 | Невідома |
| UB-12 | TODO (jotai scope) | library.ts | 253 | Висока |
| UB-13 | Implicit SM | App.tsx | 662, 3360 | Висока |
| UB-14 | Implicit SM | App.tsx | 587–607 | Висока |
| UB-15 | Implicit SM | cursor.ts | 37–38 | Середня |
| UB-16 | Implicit SM | i18n.ts | 89–90 | Середня |
| UB-17 | Implicit SM | Hyperlink.tsx | 61, 384 | Середня |
| UB-18 | Implicit SM | Fonts.ts | 61, 400 | Висока |
| UB-19 | Implicit SM | actionExport.tsx | 167 | Середня |
| UB-20 | Side Effect | App.tsx | 3066–3070 | Середня |
| UB-21 | Side Effect | Collab.tsx | 246–252 | Середня |
| UB-22 | Side Effect | App.tsx | 2061 | Висока |
| UB-23 | Side Effect | App.tsx | 4461–4475 | Висока |
| UB-24 | Side Effect | App.tsx | 11489 | Середня |
| UB-25 | Side Effect | library.ts | 591 | Висока |
| UB-26 | Init Order | elbowArrow.ts | 995, 1059 | Висока |
| UB-27 | Init Order | App.tsx | 662–3360 | Висока |
| UB-28 | Init Order | app-jotai.ts + Collab.tsx | 13, 243 | Висока |
| UB-29 | Init Order | LocalData.ts | 118–134 | Висока |
| UB-30 | Init Order | library.ts | 108–114 | Середня |
| UB-31 | Async Race | App.tsx | 2511–2600 | Висока |
| UB-32 | Async Race | App.tsx | 11448–11540 | Висока |
| UB-33 | Async Race | Collab.tsx | 139 | Середня |
