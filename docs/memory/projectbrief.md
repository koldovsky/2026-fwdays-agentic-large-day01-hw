...
Основний репозиторій — монорепо, яке містить як публічний вебзастосунок (`excalidraw-app`), так і бібліотечні пакети (`packages/*`).
...
- Ліцензія: **MIT**
- Версія app: `1.0.0` / packages: `0.18.0`

> Версії Node.js, Yarn та інші деталі середовища → [techContext.md](techContext.md)
