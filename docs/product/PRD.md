...
## Summary
- Reverse-engineered PRD describing Excalidraw as implemented in this repository.
- Statements are source-backed; roadmap or marketing claims are intentionally excluded unless represented in code.
...
## Actions
- Keep feature and flow sections aligned with active implementation paths in package and app workspaces.
- Refresh this PRD when collaboration, persistence, export, or AI integration paths change.
...
- [`../memory/activeContext.md`](../memory/activeContext.md)
