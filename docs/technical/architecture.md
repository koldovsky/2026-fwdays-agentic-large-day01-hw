...
## Summary
- Repository architecture map for packages, runtime data flow, state management, and rendering.
- Content is source-grounded and intended for implementation-focused onboarding.
...
## Actions
- Keep dependency versions and build order synchronized with workspace manifests and scripts.
- Update data-flow and state sections when `App.tsx`, `Store`, `History`, or collaboration code paths change.
...
- [`./code-notes.md`](./code-notes.md)
- [`../product/PRD.md`](../product/PRD.md)
- [`../product/domain-glossary.md`](../product/domain-glossary.md)
- [`../memory/projectbrief.md`](../memory/projectbrief.md)
- [`../memory/systemPatterns.md`](../memory/systemPatterns.md)
- [`../memory/techContext.md`](../memory/techContext.md)